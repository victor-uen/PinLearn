...
class NotesPage(QWidget):
    ...
    def __init__(self):
        ...
        self.list_widget.setStyleSheet(f"QListWidget {{background:{WHITE};border:1.5px solid {BORDER};border-radius:8px;font-size:14px;}} QListWidget::item {{padding:14px;border-bottom:1px solid {BORDER};}} QListWidget::item:selected {{background:{RED_SEAL};color:white;}}")
        ...
        self.prev_title=QLabel("Selecione uma anotação"); self.prev_title.setFont(QFont("Segoe UI",18,QFont.Weight.Bold)); self.prev_title.setWordWrap(True)
        self.prev_meta=QLabel(""); self.prev_meta.setStyleSheet(f"color:{MUTED}; font-size:13px;")
        ...
        pw_icon=QLabel("字"); pw_icon.setStyleSheet(f"color:{RED_SEAL}; font-size:18px; font-weight:bold;"); pw_icon.setFixedWidth(28)
        self.pw_text=QLabel(""); self.pw_text.setStyleSheet(f"color:{INK}; font-size:15px;")
        pw_arr=QLabel("→ Ver palavra"); pw_arr.setStyleSheet(f"color:{RED_SEAL}; font-size:14px; font-weight:bold;")
        ...
        self.prev_body=QTextEdit(); self.prev_body.setReadOnly(True); self.prev_body.setStyleSheet("border:none; background:transparent; font-size:15px;")
